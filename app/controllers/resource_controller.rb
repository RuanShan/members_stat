class ResourceController < ApplicationController
  ...
  def resource
    ...
    @resource = Resource.new controller_path, controller_name, parent_model_name, object_name
  end
  ...
  def collection_url(options = {})
    if parent_data.present?
      polymorphic_url([parent, model_class], options)
    else
      polymorphic_url([ model_class], options)
    end
  end
